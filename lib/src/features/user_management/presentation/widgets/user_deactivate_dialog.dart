...
class UserDeactivateDialog extends StatefulWidget {
  final UserEntity user;
  final VoidCallback onUserDeactivated;

  const UserDeactivateDialog({
    super.key,
    required this.user,
    required this.onUserDeactivated,
  });

  @override
  State<UserDeactivateDialog> createState() => _UserDeactivateDialogState();
}

class _UserDeactivateDialogState extends State<UserDeactivateDialog> {
      ...
      builder: (context, state) {
        ...
        return Row(
          ...
          children: [
            ...
            SizedBox(width: 12.w),
            ElevatedButton(
              onPressed: isLoading ? null : _deactivateUser,
  ...
  void _deactivateUser() {
    if (_formKey.currentState!.validate()) {
      context.read<UserBloc>().add(UserEvent.deactivateUser(
